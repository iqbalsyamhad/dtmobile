dreamtour.controller('doatambahanController', ['$scope', '$http','cfpLoadingBar', 
  function doatambahanController($scope, $http, cfpLoadingBar) {
    $scope.madinahs = [{name : "Doa ketika memasuki kota Madinah", images : ['image/DOADOA TAMBAHAN/Doa Ziarah di Kota Madinah/DoaketikamemasukikotaMadinah.jpg']},
    ...
    $scope.makkahs = [{name : "Doa ketika memasuki kota Makkah", images : ['image/DOADOA TAMBAHAN/Doa Ziarah di Kota Makkah/DoaketikamemasukikotaMakkah.jpg']},
